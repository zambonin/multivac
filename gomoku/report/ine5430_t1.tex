                ...
                [.$5_{\beta = \cc{+\infty} 5}^{\alpha = -\infty}$
                    [.$5_{\beta = +\infty}^{\alpha = \cc{-\infty} 5}$
                        [.$5_{\beta = \cc{+\infty} \cc{7} 5}^{\alpha = -\infty}$
                            [ .{7 \\ $\scriptstyle\alpha = -\infty$
                                    \\ $\scriptstyle\beta = 7$} ]
                            [ .{5 \\ $\scriptstyle\alpha = -\infty$
                                    \\ $\scriptstyle\beta = 5$} ]
                        ]
                        [.$2_{\beta = \cc{+\infty} \cc{9} 2}^{\alpha = -\infty}$
                            [ .{9 \\ $\scriptstyle\alpha = -\infty$
                                    \\ $\scriptstyle\beta = 9$} ]
                            [ .{2 \\ $\scriptstyle\alpha = -\infty$
                                    \\ $\scriptstyle\beta = 2$} ]
                            [ .{\cancel{1} \\ $\scriptstyle\alpha = -\infty$
                                    \\ $\scriptstyle\beta = 1$} ]
                        ]
                    ]
                ...
                [.$3_{\beta = \cc{+\infty} 9}^{\alpha = 5}$
                    [.$9_{\beta = +\infty}^{\alpha = \cc{5} \cc{7} 9}$
                        ...
                        [.$9_{\beta = \cc{+\infty} 9}^{\alpha = 7}$
                            [ .{9 \\ $\scriptstyle\alpha = -\infty$
                                    \\ $\scriptstyle\beta = 9$} ]
                            [ .{10 \\ $\scriptstyle\alpha = -\infty$
                                    \\ $\scriptstyle\beta = 10$} ]
                        ]
                    ]
                    [.$3_{\beta = 9}^{\alpha = 5}$
                        [.$^{*}3_{\beta = \cc{9} 3}^{\alpha = 5}$
                            [ .{3 \\ $\scriptstyle\alpha = -\infty$
                                    \\ $\scriptstyle\beta = 3$} ]
                        ]
                    ]
                ]
